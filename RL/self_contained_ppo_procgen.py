...
class Agent(nn.Module):
    def __init__(self, envs):
        ...
        self.actor = nn.Sequential(nn.Linear(in_features=256, out_features=200),
                                   nn.ReLU(),
        ...
        self.critic = nn.Sequential(nn.Linear(in_features=256, out_features=200),
                                    nn.ReLU(),
                                    nn.Linear(in_features=200, out_features=200),
                                    nn.ReLU(),
    ...
    def save_weights(self, env_name, env_mode, optim, seed):
        path = "../models/self_contained_ppo_procgen_models/" + env_name + "/" + env_name + "_" + env_mode + "_seed_" + str(
            seed) + "_weights.pth"
...
def main(seed):
    ...
    # env setup
    envs = ProcgenEnv(num_envs=args.num_envs, env_name=args.gym_id, num_levels=args.num_levels, start_level=args.start_level,
